...
import { clearPendingProviderSignup, providerAPI, saveAuth } from '../../utils/api';
...
export default function OtpPage() {
  ...
  const resolveNextRoute = async (user) => {
    ...
    try {
      ...
      console.warn('Provider profile check failed after OTP verification:', err);
      return '/provider';
    }
  };
