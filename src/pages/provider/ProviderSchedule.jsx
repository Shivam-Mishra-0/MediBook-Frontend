...
function AddSlotModal({ providerId, onClose, onDone }) {
  const [form, setForm] = useState({
    date: '', startTime: '', endTime: '', durationMinutes: 30, recurrence: 'DAILY', recurrenceEndDate: ''
  });
...
const submit = async () => {
    ...
    try {
      ...
      else if (mode === 'recurring') await slotAPI.generateRecurring({ ...payload, recurrence: form.recurrence });
      onDone();
